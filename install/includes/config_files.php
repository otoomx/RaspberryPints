...
****************************************************************************/
	...
	$mainconfigstring .= "mysqli_connect($con,'" . $servername . "', '" . $dbuser . "', '" . $dbpass1 . "');\n";
	$mainconfigstring .= "        mysqli_select_db($con,'raspberrypints');\n";
	$mainconfigstring .= "	}\n";
	...
	$adminconfig1 .= '   mysqli_connect($conn, "$host", "$username", "$password")or die("cannot connect to server");' . "\n";
